   ...
   <div className="App">
      ...
      <form className='form'>
        ...
        <div className="phancon2">
          ...
          <a href="https://jojo.fandom.com/wiki/Battle_Tendency" className = "a2">
      ...
      <div className="phan2">
        <div className="phancon3">
          ...
          <a href="https://jojo.fandom.com/wiki/Stardust_Crusaders" className = "a3">
        ...
        <div className="phancon4">
          ...
          <a href="https://jojo.fandom.com/wiki/Diamond_is_Unbreakable" className = "a4">
      ...
      <div className="phan4">
        <div className="phancon7">
          ...
          <a href="https://jojo.fandom.com/wiki/Steel_Ball_Run" className = "a7">
      ...
      className = 'id0' alt='images'></img>
        <div className = 'id1'>
          ...
          <iframe className="NgheNhac" src="https://www.nhaccuatui.com/mh/auto/lRRsEac9yId0" width="100" height="100" frameborder="100" allowfullscreen allow="autoplay" title="NgheNhac"></iframe>
          <div className="id3">
